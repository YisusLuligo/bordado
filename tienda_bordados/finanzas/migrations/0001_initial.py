...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_movimiento', models.CharField(choices=[('entrada', 'Entrada (Compra)'), ('salida_venta', 'Salida (Venta Directa)'), ('salida_pedido', 'Salida (Uso en Pedido)'), ('ajuste', 'Ajuste de Inventario'), ('devolucion', 'Devolución')], max_length=20)),
