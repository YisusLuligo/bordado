...
export const finanzasAPI = {
  ...
  // ⭐ NUEVO: Devoluciones
  getDevoluciones: (params = {}) => api.get('/finanzas/devoluciones/', { params }),
  createDevolucion: (data) => api.post('/finanzas/devoluciones/', data),
  updateDevolucion: (id, data) => api.put(`/finanzas/devoluciones/${id}/`, data),
  deleteDevolucion: (id) => api.delete(`/finanzas/devoluciones/${id}/`),
