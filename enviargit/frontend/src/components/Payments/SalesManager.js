                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                          {sale.detalles.map((detalle, index) => (
                            <span key={index} style={{
                              ...
                              {detalle.producto_info?.nombre || 'Producto'} x{Math.floor(detalle.cantidad)}
                            </span>
                          ))}
                        </div>
                      </div>
...
// Componente modal para ver detalles de venta
            ...
            <div className="grid grid-cols-2" style={{ gap: '1rem' }}>
              <div>
                ...
                <div style={{ marginTop: '0.25rem', color: '#1f2937' }}>
                  {sale.cliente_info?.nombre || 'Cliente general'}
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ marginTop: '0.25rem', color: '#1f2937', textTransform: 'capitalize' }}>
                  {sale.metodo_pago_display || sale.metodo_pago}
                </div>
              </div>
                  ...
                  <div key={index} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>
                          Cantidad: {Math.floor(detalle.cantidad)} • Precio unitario: {formatCurrency(detalle.precio_unitario)}
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '0.875rem' }}>
              ...
              {sale.descuento > 0 && (
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem', color: '#dc2626' }}>
                  <span>Descuento:</span>
                  <span style={{ fontWeight: '600' }}>-{formatCurrency(sale.descuento)}</span>
                </div>
              )}
