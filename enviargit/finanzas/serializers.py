...
# ⭐ NUEVO: Serializer para devoluciones
class DevolucionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Devolucion
        fields = [
            'id', 'producto', 'producto_info', 'cantidad', 'motivo',
            'cliente', 'venta_original', 'fecha_devolucion', 'usuario'
        ]
        read_only_fields = ['fecha_devolucion', 'usuario']
...
class MovimientoInventarioSerializer(serializers.ModelSerializer):
    ...
    # ⭐ NUEVO: Información adicional para devoluciones
    devolucion_info = DevolucionSerializer(source='devolucion', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'cantidad_nueva', 'fecha', 'motivo', 'usuario', 'devolucion_info'
        ]
